      ...
      <SimpleBar style={{ height: '100%' }} className='nicescroll-bar'>
        ...
        <div className='text-center'>
          ...
          {typeof avatar === 'object' && (
            <div className={`avatar avatar-${avatar.variant} avatar-rounded avatar-xxl`}>
          ...
          <Tab.Content className='mt-4'>
            <Tab.Pane eventKey='info'>
              ...
              <div className='collapse-simple mt-3'>
                <Card>
                  <Card.Header>
                    <Link role='button' data-bs-toggle='collapse' to='#gn_info' aria-expanded='true'>
                      General Info
                    </Link>
                  </Card.Header>
                  ...
                  <div id='social_profile' className='collapse show'>
                    <Card.Body>
                      <ul className='hk-list hk-list-sm'>
                        ...
                        <li>
                          <Button variant='danger' className='btn-icon btn-rounded'>
                            <span className='icon'>
            ...
            <Tab.Pane eventKey='files'>
              ...
              <div className='collapse-simple mt-3'>
                <Card>
                  <Card.Header>
                    <Link role='button' data-bs-toggle='collapse' to='#files_collapse' aria-expanded='true'>
                      Yesterday
                    </Link>
                  </Card.Header>
                ...
                <Card>
                  <Card.Header>
                    <Link role='button' data-bs-toggle='collapse' to='#files_collapse_1' aria-expanded='true'>
                      23 April
                    </Link>
                  </Card.Header>
