      ...
      <div className='chatapp-aside'>
        ...
        <SimpleBar style={{ height: '100%' }} className='aside-body'>
          ...
          <div className='frequent-contact'>
            <div className='title-sm text-primary'>
              ...
              <ListGroup.Item onClick={() => Conversation(index)} key={index}>
                <div className={classNames('media', { 'active-user': elem.id === userId }, { 'read-chat': !elem.unread })}>
                  <div className='media-head'>
                    ...
                    {elem.initAvatar && (
                      <div className={`avatar avatar-sm avatar-${elem.initAvatar.variant} avatar-rounded`}>
                  ...
                  <div className='media-body'>
                    ...
                    <div>
                      ...
                      <div className='dropdown action-drp'>
                        <a href='#some' className='btn btn-icon btn-flush-dark btn-rounded flush-soft-hover dropdown-toggle no-caret' data-bs-toggle='dropdown'>
                          <span className='icon'>
                            <span className='feather-icon'>
