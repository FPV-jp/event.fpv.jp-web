        ...
        <div className='task-detail-body'>
          ...
          <Form as={Row}>
            ...
            <Col md={6}>
              ...
              <Dropdown>
                <Dropdown.Toggle variant='warning' className='btn-rounded dropdown-toggle'>
                  In Progress
                </Dropdown.Toggle>
                <Dropdown.Menu>
          ...
          <Tab.Container defaultActiveKey='checklist'>
            ...
            <Tab.Content className='mt-7'>
                ...
                <div className='card card-border note-block bg-orange-light-5'>
                  <Card.Body>
                    <div className='card-action-wrap'>
                      <Dropdown>
                        <Dropdown.Toggle size='xs' variant='flus-soft' className='btn-icon btn-rounded flush-soft-hover dropdown-toggle no-caret'>
                          <span className='icon'>
                            <span className='feather-icon'>
                              <Icons.MoreVertical />
                            </span>
              ...
              <Tab.Pane eventKey='files'>
                <Row>
                  <Col sm>
                    <HkFileInput>Drop files here to upload</HkFileInput>
                  </Col>
                </Row>
                ...
                <div className='file-block'>
                  <div className='collapse-simple'>
                    ...
                    <Card>
                      <Card.Header>
                        <a role='button' data-bs-toggle='collapse' href='#files_collapse_1' aria-expanded='true'>
                          23 April
                        </a>
                      </Card.Header>
