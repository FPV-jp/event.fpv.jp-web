...
const DragCard = ({ cards, tasks, cardOrder, setCards, setTasks, setCardOrder, taskInfo }) => {
        ...
        {(provided) => (
          <div {...provided.droppableProps} ref={provided.innerRef}>
            {cardOrder.map((id, index) => {
              ...
              return <Board key={card.id} card={card} tasks={cardTasks} index={index} onRemoveTask={onRemoveTask} taskInfo={taskInfo} />
            })}
