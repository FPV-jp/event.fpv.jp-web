...
const tagFormater = (cell) =>
  cell ? (
    <Badge size='sm' bg='white' className={classNames('badge-outline badge-wth-icon', { 'badge-danger': cell === 'High' || cell === 'Urgent' }, { 'badge-warning': cell === 'Low' }, { 'badge-orange': cell === 'Medium' })}>
      <span>
...
const statusFormater = (cell) => {
  return cell.map((data, indx) => (
    <Dropdown className='selectable-dropdown'>
      <Dropdown.Toggle variant={data.variant} className='btn-rounded' type='button'>
        {data.status}
      </Dropdown.Toggle>
      <Dropdown.Menu>
