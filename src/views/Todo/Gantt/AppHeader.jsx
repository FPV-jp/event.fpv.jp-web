  ...
  return (
    <header className='todo-header'>
      ...
      <ButtonGroup className='d-md-inline-flex d-none' role='group' id='modes-filter'>
        <Button name='modes' id='qday' variant='outline-light' onClick={() => ganttViewMode('QuarterDay')} active={vm === 'QuarterDay'}>
          Quarter Day
        </Button>
        <Button name='modes' id='hday' variant='outline-light' onClick={() => ganttViewMode('Half Day')} active={vm === 'Half Day'}>
          Half Day
        </Button>
        <Button name='modes' id='day' variant='outline-light' onClick={() => ganttViewMode('Day')} active={vm === 'Day'}>
          Day
        </Button>
        <Button name='modes' id='week' variant='outline-light' onClick={() => ganttViewMode('Week')} active={vm === 'Week'}>
          Week
        </Button>
        <Button name='modes' id='month' variant='outline-light' onClick={() => ganttViewMode('Month')} active={vm === 'Month'}>
          Month
        </Button>
      </ButtonGroup>
