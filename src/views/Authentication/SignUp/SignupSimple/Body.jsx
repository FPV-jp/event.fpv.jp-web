              ...
              <Row>
                <Col xxl={9} xl={8} lg={11} className='mx-auto'>
                  <div className='text-center'>
                    ...
                    <p>
                      Start your <mark>14days free</mark> trial.
                    </p>
                  </div>
                  ...
                  <p className='mt-5 p-xs credit-text text-center text-light'>
              ...
              <Form className='w-100'>
                <Row>
                  <Col lg={10} className='mx-auto'>
                    ...
                    <Button variant='primary' className='btn-rounded btn-uppercase btn-block' as={Link} to='login-simple'>
                      Create account
                    </Button>
