...
const ChatBotInterface = ({ show, sendMsg, msg }) => {
  ...
  return (
    <>
              ...
              <div className={classNames('init-content-wrap', { 'd-none': startConversation })}>
                <Card className='card-shadow'>
                  <Card.Body>
                    ...
                    <Button variant='primary' className='btn-block text-nonecase start-conversation' onClick={() => setStartConversation(!startConversation)}>
      ...
      <div className={classNames('chat-popover shadow-xl', { 'd-flex': showPopup })}>
