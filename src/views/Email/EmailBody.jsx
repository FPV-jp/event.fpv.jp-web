      ...
      <SimpleBar className='nicescroll-bar'>
        <div className='single-email-subject'>
          <div>
            ...
            <Badge bg='orange' pill className='badge-sm flex-shrink-0 ms-3'>
              updates
            </Badge>
          </div>
                    ...
                    <div className='media-body'>
                      ...
                      <div className='fs-7'>
                        ...
                        <Dropdown bsPrefix='mail-desc-dropdown'>
                          <Dropdown.Toggle as='a' className='link-dark ms-1' href='#'>
                            me
                          </Dropdown.Toggle>
                          <Dropdown.Menu>
                            <div>
                              <span>from :</span>
                              <span>
                                Morgan <span>&lt;morganfreeman@jampack.com&gt;</span>
                              </span>
                            </div>
                            <div>
                              <span>to :</span>
                              <span>
                                Hencework <span>&lt;contact@hencework.com&gt;</span>
                              </span>
                            </div>
                            <div>
                              <span>date :</span>
            ...
            <div id='simple-collapseOne' className='accordion-collapse collapse'>
              <div className='accordion-body'>
                ...
                <div className='text-end'>
                  <a href='#some' className='link-theme fs-7'>
                    <u>Download All</u>
                  </a>
                </div>
