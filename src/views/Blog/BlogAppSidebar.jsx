      ...
      <nav className='blogapp-sidebar'>
        <SimpleBar className='nicescroll-bar'>
          <div className='menu-content-wrap'>
            <Link to='add-new-post' className='btn btn-primary btn-rounded btn-block mb-4'>
              Create Post
            </Link>
              ...
              <Nav as='ul' className='nav-light navbar-nav flex-column'>
                <Nav.Item as='li'>
                  <Nav.Link className='link-badge-right'>
                    ...
                    <HkBadge pill size='sm' soft bg='primary' className='ms-auto'>
                      136
                    </HkBadge>
                  </Nav.Link>
                </Nav.Item>
            ...
            <div className='menu-group'>
              <div className='tag-cloud'>
                <Link to='#' className='badge badge-outline badge-light'>
                  Collaboration
                </Link>
                <Link to='#' className='badge badge-outline badge-light'>
                  React Developer
