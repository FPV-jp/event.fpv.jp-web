                      ...
                      <Tab.Content className='mt-0'>
                        ...
                        <Tab.Pane eventKey='tabCode'>
                          <div contentEditable='true' suppressContentEditableWarning={true}>
                            &lt;div class="col"&gt; &lt;a href="#some"&gt; &lt;div class="card card-border" style="background-image:url('dist/img/gallery/mock5.jpg');"&gt; &lt;/div&gt; &lt;/a&gt; &lt;/div&gt;
                          </div>
                        </Tab.Pane>
                      </Tab.Content>
                    </Card.Body>
                      ...
                      <Tab.Content>
                        <Tab.Pane eventKey='summery'>
                          ...
                          <Row sm className='row-cols-xl-6 row-cols-lg-3 row-cols-sm-2 row-cols-1 uploaded-img-prev'>
                            <Col>
                              <Link to='#'>
                                <Card className='card-border' style={{ backgroundImage: `url(${mock1})` }}></Card>
                              </Link>
                            </Col>
                            <Col>
                              <Link to='#'>
                                <Card className='card-border' style={{ backgroundImage: `url(${mock2})` }}></Card>
                              </Link>
                            </Col>
                            <Col>
                              <Link to='#'>
                                <Card className='card-border' style={{ backgroundImage: `url(${mock3})` }}></Card>
                              </Link>
                            </Col>
                            <Col>
                              <Link to='#'>
                                <Card className='card-border' style={{ backgroundImage: `url(${mock4})` }}></Card>
                              </Link>
                            </Col>
                            <Col>
                              <Link to='#'>
                                <Card className='card-border' style={{ backgroundImage: `url(${mock5})` }}></Card>
                              </Link>
                            </Col>
                            <Col>
                              <Link to='#'>
                                <Card className='card-border' style={{ backgroundImage: `url(${mock6})` }}></Card>
                              </Link>
                            </Col>
                          </Row>
                        </Tab.Pane>
