    ...
    <div className='content-aside'>
            ...
            <Tab.Container defaultActiveKey='tabCat'>
              ...
              <Tab.Content>
                <Tab.Pane eventKey='tabCat'>
                  <div className='h-180p'>
                    <SimpleBar className='nicescroll-bar p-0'>
                      <Form.Check type='checkbox' label='Design' id='catchk1' />
                      <Form.Check type='checkbox' label='Development' id='catchk2' />
                      <Form.Check type='checkbox' label='Technology' id='catchk3' />
                      <Form.Check type='checkbox' label='Business' id='catchk4' />
                      <Form.Check type='checkbox' label='Social Media' id='catchk5' />
                      <Form.Check type='checkbox' label='Sports' id='catchk6' />
                      <Form.Check type='checkbox' label='Writing' id='catchk7' />
                    </SimpleBar>
                  </div>
                </Tab.Pane>
                <Tab.Pane eventKey='tabFreq'>
                  <div className='h-180p'>
                    <SimpleBar className='nicescroll-bar p-0'>
                      <Form.Check type='checkbox' label='Design' id='catchk8' />
                      <Form.Check type='checkbox' label='Development' id='catchk9' />
                      <Form.Check type='checkbox' label='Technology' id='catchk10' />
                      <Form.Check type='checkbox' label='Business' id='catchk11' />
                    </SimpleBar>
                  </div>
                </Tab.Pane>
              </Tab.Content>
      ...
      <Card className='card-border'>
        ...
        <div id='tags_1' className='collapse show'>
          <Card.Body>
            <HkTags options={multiSelectOpt} defaultValue={[multiSelectOpt[0], multiSelectOpt[1], multiSelectOpt[2], multiSelectOpt[3]]} />
          </Card.Body>
        </div>
      </Card>
      <Card className='card-border overflow-hidden'>
        ...
        <div id='prev_1' className='collapse show'>
          <Card.Body>
            <HkDropZone>
              ...
              <div className='fw-light text-muted'> Make your blog post inviting</div>
            </HkDropZone>
          </Card.Body>
        </div>
      </Card>
