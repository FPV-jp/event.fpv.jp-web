...
const tagFormater = (cell) => {
  return cell.map((data, indx) => (
    <HkBadge bg={data.bg} soft className='my-1  me-2' key={indx}>
      {data.title}
    </HkBadge>
  ))
}
...
export const data = [
...

  {
    ...
    tags: [
      { title: 'Collaborator', bg: 'danger' },
      { title: 'Angular Developer', bg: 'success' },
    ],
    labels: 'Developer',
    dateCreated: '13 Jan, 2020',
    actions: [{ archiveLink: '#', editLink: 'edit-contact', deleteLink: '#' }],
...

  {
    ...
    phone: '+145 52 5463',
    tags: [
      { title: 'Promotion', bg: 'danger' },
      { title: 'Advertisement', bg: 'light' },
    ],
...

  {
    ...
    tags: [
      { title: 'Collaborator', bg: 'danger' },
      { title: 'Angular Developer', bg: 'warning' },
    ],
    labels: 'Inventory',
