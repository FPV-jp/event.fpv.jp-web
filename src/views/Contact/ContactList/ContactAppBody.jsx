    ...
    <div className='contact-body'>
      <SimpleBar className='nicescroll-bar'>
          ...
          <div className='quick-access-form-wrap'>
            <Form className='quick-access-form border'>
              <Row className='gx-3'>
                ...
                <Col xxl={2}>
                  <Form.Group className='mb-3'>
                    <Button variant='primary' data-bs-toggle='collapse' data-bs-target='#collapseExample' aria-expanded='false' className='btn-block'>
                      Create New
                    </Button>
                  </Form.Group>
                  <Form.Group className='mb-3'>
                    <Button variant='secondary' data-bs-toggle='collapse' disabled data-bs-target='#collapseExample' aria-expanded='false' className='btn-block'>
                      Discard
                    </Button>
                  </Form.Group>
                </Col>
        ...
        <div className='contact-list-view'>
          ...
          <HkDataTable column={columns} rowData={data} rowsPerPage={10} rowSelection={true} markStarred={true} searchQuery={searchTerm} classes='nowrap w-100 mb-5' responsive />
        </div>
      </SimpleBar>
    </div>
  )
