            ...
            <div className='d-flex flex-xl-nowrap flex-wrap'>
              <div className='contact-info w-xl-35 w-100'>
                <Dropdown className='action-btn'>
                  <Dropdown.Toggle className='btn btn-light dropdown-toggle ' type='button'>
                    Action
                  </Dropdown.Toggle>
                  <Dropdown.Menu>
                    <Dropdown.Item>Action</Dropdown.Item>
                        ...
                        <div className='media-body'>
                          <div>
                            <div className='activity-text'>
                              You sent <span className='text-dark text-capitalize'>1 message</span> to the contact.
                            </div>
                    ...
                    <li>
                      <div className='media'>
                        ...
                        <div className='media-body'>
                          <div>
                            <div className='activity-text'>
                              <span className='text-dark text-capitalize'>Morgan Freeman</span> as it is sometimes known, is dummy text used in laying out print, graphic or web designs. The passage is attributed to an unknown typesetter in the 15th century who is thought to have scrambled.
                            </div>
                            <div className='activity-time'>10.00 pm</div>
                          </div>
                        </div>
                    ...
                    <li>
                      <div className='media'>
                        ...
                        <div className='media-body'>
                          <div>
                            <div className='activity-text'>
                              Your deal value <span className='text-dark'>$208.15</span> is paid through PayU Money online on <span className='text-dark'>02.12.18</span> at <span className='text-dark'>15:30, Monday</span>
                            </div>
                            <div className='activity-time'>10.00 pm</div>
                          </div>
                        </div>
