            ...
            <div className='quick-access-form-wrap'>
              <Form className='quick-access-form border'>
                <Row className='gx-3'>
                  ...
                  <Col xxl={2}>
                    <Form.Group>
                      <button data-bs-toggle='collapse' data-bs-target='#collapseExample' aria-expanded='false' className='btn btn-block btn-primary '>
                        Create New
                      </button>
                    </Form.Group>
                    <Form.Group>
                      <button data-bs-toggle='collapse' disabled data-bs-target='#collapseExample' aria-expanded='false' className='btn btn-block btn-secondary'>
                        Discard
                      </button>
                    </Form.Group>
                  </Col>
            ...
            <Row className='mb-3'>
              ...
              <Col xs={5} mb={3}>
                <div className='contact-toolbar-right'>
                  ...
                  <div className='dataTables_info' id='datable_1_info' role='status' aria-live='polite'>
                    1 - 10 of 11
                  </div>
                  <div className='dataTables_paginate paging_simple_numbers' id='datable_1_paginate'>
                    <ul className='pagination custom-pagination pagination-simple m-0'>
                      ...
                      <li className='paginate_button page-item active'>
                        <a href='#some' data-dt-idx={1} tabIndex={0} className='page-link'>
                          1
                        </a>
                      </li>
                      <li className='paginate_button page-item '>
                        <a href='#some' data-dt-idx={2} tabIndex={0} className='page-link'>
                          2
                        </a>
                      </li>
                ...
                <Card className='card-border contact-card'>
                  <Card.Body className='text-center'>
                    ...
                    <div className='user-desg'>
                      <span className='badge badge-primary badge-indicator badge-indicator-lg me-2' /> Design
                    </div>
                  </Card.Body>
              ...
              <div className='col'>
                <Card className='card card-border contact-card'>
                  <Card.Body className='text-center'>
                    ...
                    <div className='user-desg'>
                      <span className='badge badge-primary badge-indicator badge-indicator-lg me-2' /> Developer
                    </div>
                  </Card.Body>
                  <Card.Footer className='text-muted position-relative'>
                    <Link to='#' className='d-flex align-items-center'>
              ...
              <div className='col'>
                <Card className='card card-border contact-card'>
                  <Card.Body className='text-center'>
                    ...
                    <div className='user-desg'>
                      <span className='badge badge-danger badge-indicator badge-indicator-lg me-2' /> Inventory
                    </div>
                  </Card.Body>
                  <Card.Footer className='text-muted position-relative'>
                    <Link to='#' className='d-flex align-items-center'>
              ...
              <div className='col'>
                <Card className='card card-border contact-card'>
                  <Card.Body className='text-center'>
                    ...
                    <div className='user-desg'>
                      <span className='badge badge-danger badge-indicator badge-indicator-lg me-2' /> Human Resource
                    </div>
                  </Card.Body>
                  <Card.Footer className='text-muted position-relative'>
                    <Link to='#' className='d-flex align-items-center'>
              ...
              <div className='col'>
                <Card className='card card-border contact-card'>
                  <Card.Body className='text-center'>
                    ...
                    <div className='user-desg'>
                      <span className='badge badge-success badge-indicator badge-indicator-lg me-2' /> Design
                    </div>
                  </Card.Body>
                  <Card.Footer className='text-muted position-relative'>
                    <Link to='#' className='d-flex align-items-center'>
              ...
              <div className='col'>
                <Card className='card card-border contact-card'>
                  <Card.Body className='text-center'>
                    ...
                    <div className='user-contact'>+145 52 1916</div>
                    <div className='user-desg'>
                      <span className='badge badge-warning badge-indicator badge-indicator-lg me-2' /> Human Resource
                    </div>
                  </Card.Body>
                  <Card.Footer className='text-muted position-relative'>
                    <Link to='#' className='d-flex align-items-center'>
