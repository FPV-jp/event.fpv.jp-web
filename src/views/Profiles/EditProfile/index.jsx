...
const EditProfile = ({ toggleCollapsedNav, sidebarDataHover }) => {
  useEffect(() => {
                  ...
                  <Form>
                    ...
                    <Row className='gx-3'>
                      <Col sm={12}>
                        <Form.Group className='mb-3'>
                          ...
                          <Form.Text muted>Brief bio about yourself. This will be displayed on your profile page.</Form.Text>
                        </Form.Group>
                      </Col>
                    </Row>
                    <div className='title title-xs title-wth-divider text-primary text-uppercase my-4'>
                    ...
                    <Row className='gx-3'>
                      ...
                      <Col sm={12}>
                        ...
                        <Form.Check type='checkbox' id='customCheckList4' label='Keep my number private' />
                      </Col>
                    </Row>
                    ...
                    <Row className='gx-3'>
                      <Col sm={12}>
                        <Form.Group className='mb-3'>
                          ...
                          <Form.Text muted>Track shot and profile views in your Google analytics account, eg. UA-0000000-0</Form.Text>
                        </Form.Group>
                      </Col>
                    </Row>
                    <div className='title title-xs title-wth-divider text-primary text-uppercase my-4'>
                      ...
                      <Col sm={12}>
                        <Form.Check className='form-check-lg'>
                          ...
                          <Form.Text muted className='d-block'>
                            People who have your email address will be able to connect you by Jampack
                          </Form.Text>
                        </Form.Check>
                        ...
                        <Form.Check className='form-check-lg'>
                          ...
                          <Form.Text muted className='d-block'>
                            No one can find you by your phone number. Your phone number will not be shared with your contact anymore.
                          </Form.Text>
                        </Form.Check>
                        <div className='separator' />
                        <Form.Check className='form-check-lg'>
                        ...
                        <Form.Check className='form-check-lg'>
                          ...
                          <Form.Text muted className='d-block'>
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque condimentum mauris volutpat enim ornare iaculis. Curabitur euismod rutrum lorem id lobortis. Cras ut ex dui. Nulla sed blandit tortor. In quam diam, efficitur sit amet pulvinar eget, consequat placerat arcu.
                          </Form.Text>
                        </Form.Check>
                      </Col>
                    </Row>
...
export default connect(mapStateToProps, { toggleCollapsedNav, sidebarDataHover })(EditProfile)
