...
import symbolAvatar17 from 'assets/dist/img/symbol-avatar-17.png'
import symbolAvatar18 from 'assets/dist/img/symbol-avatar-18.png'
import symbolAvatar19 from 'assets/dist/img/symbol-avatar-19.png'
import visaCard from 'assets/dist/img/card-visa.png'
import masterCard from 'assets/dist/img/mastercard.png'

const Account = ({ toggleCollapsedNav, sidebarDataHover }) => {
  useEffect(() => {
                ...
                <Col md={8}>
                  ...
                  <Form>
                    <Form.Group className='mb-3'>
                      ...
                      <Form.Text muted>One-click sign in</Form.Text>
                    </Form.Group>
                    <Form.Group className='mb-3'>
            ...
            <Tab.Pane eventKey='tabBlock3'>
              <Row>
                <Col md={8}>
                  ...
                  <p className='mb-4'>Connect suitable apps with your app and get notifications wherever you go</p>
                        ...
                        <div className='media align-items-center'>
                          ...
                          <div className='media-body'>
                            <div>
                              ...
                              <HkBadge bg='primary' soft className='rounded-0 ms-3'>
                                Primary
                              </HkBadge>
                            </div>
                          </div>
                    ...
                    <Col md={4}>
                      <Card className='card-border mnh-250p'>
                        <Card.Body>
                          ...
                          <h5>Home</h5>
                          <Card.Text>3421 Central Ave NE, Albuquerque, New York - 87106</Card.Text>
...
export default connect(mapStateToProps, { toggleCollapsedNav, sidebarDataHover })(Account)
