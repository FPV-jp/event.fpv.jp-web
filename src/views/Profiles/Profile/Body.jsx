      ...
      <Col lg={4} className='mb-lg-0 mb-3'>
        ...
        <Card className='card-border mb-lg-4 mb-3'>
          <Card.Header className='card-header-action'>
            <h6>
              Friends
              <HkBadge bg='light' text='dark' size='sm' className='ms-1'>
                212
              </HkBadge>
            </h6>
            <div className='card-action-wrap'>
          ...
          <ListGroup className='list-group-flush'>
            <ListGroup.Item className='border-0'>
              <div className='media align-items-center'>
                ...
                <div className='media-body'>
                  <span className='d-block text-capitalize text-truncate mw-150p'>Google</span>
              ...
              <SwiperSlide>
                <p className='tweet'>
                  ...
                  <p className='timePosted'>
                    <a href='#demo'>Posted on Jan 9, 2022</a>
                  </p>
                </p>
              </SwiperSlide>
              <SwiperSlide>
                <p className='tweet'>
                  ...
                  <p className='timePosted'>
                    <a href='#demo'>Posted on Jan 11, 2022</a>
                  </p>
                </p>
              </SwiperSlide>
            </Swiper>
      ...
      <Col lg={8}>
        <Card className='card-border card-profile-feed mb-lg-4 mb-3'>
          ...
          <Card.Footer className='justify-content-between'>
            <div>
              <Link to='#'>
                <i className='bi bi-heart-fill text-primary' />
                30K
              </Link>
            </div>
            <div>
        ...
        <div className='mb-lg-4 mb-lg-4 mb-3'>
          ...
          <Card className='card-border card-profile-feed border-top-0 rounded-top-0 mb-0'>
            <Card.Body>
              <Button variant='light' size='sm' className='btn-block mb-4'>
                Hide comments
              </Button>
