      ...
      <nav className='calendarapp-sidebar'>
        <SimpleBar className='nicescroll-bar'>
          <div className='menu-content-wrap'>
            <Dropdown>
              <Dropdown.Toggle variant='primary' className='btn-rounded btn-block'>
                Create
              </Dropdown.Toggle>
              <Dropdown.Menu>
            ...
            <div className='text-center mt-4'>
              <div id='inline_calendar' className='d-inline-block'>
                <DatePicker selected={startDate} onChange={onChange} dateFormatCalendar={'MMM yyyy'} selectsRange inline />
              </div>
            </div>
            ...
            <div className='categories-wrap'>
              <Form.Check id='customChecksc1' type='checkbox' label='Meetings' defaultChecked />
              <Form.Check id='customChecksc2' type='checkbox' label='Flights' defaultChecked />
              <Form.Check id='customChecksc3' type='checkbox' label='Birthday' defaultChecked />
              <Form.Check id='customChecksc4' type='checkbox' label='Conferences' />
            </div>
          </div>
        </SimpleBar>
        {/*Sidebar Fixnav*/}
