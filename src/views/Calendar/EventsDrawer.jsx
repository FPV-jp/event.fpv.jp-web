...
const EventsDrawer = ({ show, onClose, info, event }) => {
  ...
  const DeletEvent = () => {
    onClose()
    Swal.fire({
      html: '<div class="mb-3"><i class="ri-delete-bin-6-line fs-5 text-danger"></i></div><h5 class="text-danger">Delete Note ?</h5><p>Deleting a note will permanently remove from your library.</p>',
      customClass: {
    ...
    <div className={classNames('hk-drawer calendar-drawer drawer-right', { 'drawer-toggle': show })}>
              ...
              <ul className='event-detail'>
                ...
                <li>
                  ...
                  <div className='d-flex flex-wrap'>
                    <HkChips variant='primary' src={avatar11} className='mb-2 me-2'>
                      Morgan
                    </HkChips>
                    <HkChips variant='primary' src={avatar12} className='mb-2 me-2'>
                      Charlie
                    </HkChips>
                    <HkChips variant='primary' src={avatar13} className='mb-2 me-2'>
                      Winston
                    </HkChips>
                  </div>
                </li>
      ...
      <div className={classNames({ 'd-none': !editable })}>
          ...
          <SimpleBar className='nicescroll-bar'>
            <div className='drawer-content-wrap'>
              <div className='event-head mb-4'>
                <HkBadge bg='violet' indicator className='badge-indicator-xl flex-shrink-0 me-2' />
                <div>
                  <div id='editableContent' contentEditable='true' suppressContentEditableWarning={true} className='event-name'>
                    {info}
                  </div>
                  <Form.Group className='mt-2 mb-0'>
                    <Form.Check inline label='Event' name='group1' type='radio' id='radio-1' defaultChecked />
                    <Form.Check inline label='Reminder' name='group1' type='radio' id='radio-2' />
                  </Form.Group>
                </div>
              </div>
              <Form>
                ...
                <Form.Group className='mb-3'>
                  <InputGroup className='color-picker'>
                    <InputGroup.Text className='colorpicker-input-addon'>
                      <Form.Control type='color' id='exampleColorInput' title='Choose your color' value={eventColor} onChange={(e) => setEventColor(e.target.value)} />
                    </InputGroup.Text>
                ...
                <Form.Group className='mb-3'>
                  <div className='d-flex flex-wrap'>
                    <HkChips variant='primary' src={avatar11} dismissable className='mb-2 me-2'>
                      Morgan
                    </HkChips>
                    <HkChips variant='primary' src={avatar12} dismissable className='mb-2 me-2'>
                      Charlie
                    </HkChips>
                    <HkChips variant='primary' src={avatar13} dismissable className='mb-2 me-2'>
                      Winston
                    </HkChips>
        ...
        <div className='drawer-footer d-flex justify-content-end'>
          <Button variant='secondary' className='drawer-edit-close me-2' onClick={() => setEditable(!editable)}>
            discard
          </Button>
          <Button variant='primary' className='drawer-edit-close' onClick={() => setEditable(!editable)}>
            save
          </Button>
        </div>
      </div>
