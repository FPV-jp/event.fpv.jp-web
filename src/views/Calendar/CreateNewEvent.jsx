  ...
  return (
    <Modal show={show} onHide={hide} size='lg' centered>
                ...
                <div className='d-flex'>
                  ...
                  <InputGroup className='color-picker w-auto'>
                    <span className='input-group-text colorpicker-input-addon rounded-3'>
                      <Form.Control type='color' id='exampleColorInput' value={backgroundColor} title='Choose your color' onChange={(e) => setBackgroundColor(e.target.value)} />
                    </span>
                  </InputGroup>
                </div>
              </Form.Group>
          ...
          <Row className='gx-3'>
            <Col sm={12}>
              <Form.Group className='mt-3'>
                ...
                <Form.Check inline label='Urgent' name='group1' type='radio' id='urgent' defaultChecked />
                <Form.Check inline label='High' name='group1' type='radio' id='high' />
                <Form.Check inline label='Low' name='group1' type='radio' id='low' />
                <Form.Check inline label='Medium' name='group1' type='radio' id='medium' />
              </Form.Group>
            </Col>
          </Row>
        </Form>
      ...
      <Modal.Footer className='align-items-center'>
        ...
        <Button variant='primary' className='fc-addEventButton-button' onClick={updateEventList}>
          Add
        </Button>
      </Modal.Footer>
    </Modal>
