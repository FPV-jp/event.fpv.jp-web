  ...
  return (
    <header className='invoice-header'>
      ...
      <div className='invoice-options-wrap'>
        ...
        <Button as={Link} to='invoice-preview' variant='outline-secondary' className='flex-shrink-0 d-md-inline-block d-none'>
          Preview
        </Button>
        <Button as='a' variant='primary' href='#some' className='mx-2 d-sm-inline-block d-none'>
          save
        </Button>
