                ...
                <Col xxl={4} className='offset-xxl-5 mt-xxl-0 mt-6'>
                  <Form>
                    ...
                    <div className='repeater'>
                      ...
                      <Link data-repeater-create className='d-inline-flex align-items-center' to='#'>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td className='w-20  rounded-end  bg-primary-light-5 close-over position-relative' rowSpan={2}>
                            <Form.Control type='text' className='bg-transparent border-0 p-0 total' value={items.totalPrice} readOnly />
