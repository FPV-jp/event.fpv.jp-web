    ...
    <div className='invoice-settings'>
      <SimpleBar className='nicescroll-bar'>
        ...
        <div className='collapse-simple mt-lg-0 mt-2'>
          <Card>
            <Card.Header>
              <a role='button' data-bs-toggle='collapse' href='#currency' aria-expanded='true'>
                Currency
              </a>
            </Card.Header>
          ...
          <Card>
            <Card.Header>
              <a role='button' data-bs-toggle='collapse' href='#typography' aria-expanded='true'>
                Typography
              </a>
            </Card.Header>
          ...
          <Card>
            <Card.Header>
              <a role='button' data-bs-toggle='collapse' href='#color' aria-expanded='true'>
                Color
              </a>
            </Card.Header>
            <div id='color' className='collapse show'>
              <div className='form-group mt-2'>
                ...
                <InputGroup className='input-group color-picker' title='Using horizontal option'>
                  <InputGroup.Text className='colorpicker-input-addon'>
                    <Form.Control type='color' id='exampleColorInput1' title='Choose your color' value={accentClr} onChange={(e) => setAccentClr(e.target.value)} />
                  </InputGroup.Text>
              ...
              <Form.Group className='mb-3'>
                ...
                <InputGroup className='input-group color-picker' title='Using horizontal option'>
                  <InputGroup.Text className='colorpicker-input-addon'>
                    <Form.Control type='color' id='exampleColorInput2' title='Choose your color' value={headingClr} onChange={(e) => setHeadingClr(e.target.value)} />
                  </InputGroup.Text>
              ...
              <Form.Group className='mb-3'>
                ...
                <InputGroup className='input-group color-picker' title='Using horizontal option'>
                  <InputGroup.Text className='colorpicker-input-addon'>
                    <Form.Control type='color' id='exampleColorInput3' title='Choose your color' value={textClr} onChange={(e) => setTextClr(e.target.value)} />
                  </InputGroup.Text>
          ...
          <Card>
            <Card.Header>
              <a role='button' data-bs-toggle='collapse' href='#action' aria-expanded='true'>
                Actions
              </a>
            </Card.Header>
          ...
          <Card>
            <Card.Header>
              <a role='button' data-bs-toggle='collapse' href='#option' aria-expanded='true'>
                Options
              </a>
            </Card.Header>
