                  ...
                  <Tab.Content className='py-7'>
                    <Tab.Pane eventKey='tabit1'>
                      ...
                      <ul className='list-ul ps-3'>
                        <li className='mb-1'>
                          <span>Kickstarter is an American public benefit corporation based in Brooklyn.</span>
                        </li>
                        <li className='mb-1'>
                          <span>New York, that maintains a global crowdfunding.</span>
                        </li>
                        <li className='mb-1'>
                          <span>platform focused on creativity. The company's stated mission.</span>
                        </li>
                        <li className='mb-1'>
                      ...
                      <div className='review-block'>
                        <div className='d-flex align-items-center justify-content-between'>
                          <div className='d-flex align-items-center'>
                            ...
                            <Button variant='soft-primary' onClick={() => setShowReviewModal(!showReviewModal)}>
                              Write a review
                            </Button>
                          </div>
                          <div>
                        ...
                        <div className='review'>
                          ...
                          <div className='d-flex flex-sm-nowrap flex-wrap mt-2 mb-1'>
                            ...
                            <div>
                              for <span className='text-dark mx-1'>Design Quality</span> <span className='fs-8'>12 Jan, 2020</span>
                            </div>
                          </div>
                          ...
                          <div className='review-action-wrap mt-3'>
                            ...
                            <Button variant='outline-light me-1' size='xs'>
                              Yes
                            </Button>
                            <Button variant='outline-light me-1' size='xs'>
                              No
                        ...
                        <div className='review'>
                          ...
                          <div className='d-flex flex-sm-nowrap flex-wrap mt-2 mb-1'>
                            ...
                            <div>
                              for <span className='text-dark mx-1'>Customer Support</span> <span className='fs-8'>10 Jan, 2020</span>
                            </div>
                          </div>
                        ...
                        <div className='review'>
                          ...
                          <div className='d-flex flex-sm-nowrap flex-wrap mt-2 mb-1'>
                            ...
                            <div>
                              for <span className='text-dark mx-1'>Design Quality</span> <span className='fs-8'>31 Dec, 2020</span>
                            </div>
                          </div>
                          ...
                          <div className='review'>
                            ...
                            <div className='d-flex flex-sm-nowrap flex-wrap mt-2 mb-1'>
                              <div>
                                <span className='fs-8'>1 Jan, 2020</span>
                              </div>
                            </div>
                  ...
                  <Card className='card-border mt-6'>
                    <Card.Body>
                      ...
                      <div className='tag-cloud'>
                        <HkBadge as={Link} to='#' bg='primary' soft className='me-1'>
                          Jampack
                        </HkBadge>
                        <HkBadge as={Link} to='#' bg='primary' soft className='me-1'>
                          Bootstrap 5
                      ...
                      <ul className='list-unstyled'>
                        ...
                        <li className='mb-3'>
                          ...
                          <div className='text-dark fw-medium d-flex align-items-center'>
                            Hencework
                            <i className='ri-information-fill fs-7 ms-1 lh-1' />
                          </div>
                        </li>
                        <li className='mb-3'>
                          ...
                          <div className='text-dark fw-medium d-flex align-items-center'>
                            ...
                            <a href='#some' className='d-flex'>
                              <i className='ri-external-link-line fs-7 ms-1 lh-1' />
                            </a>
                          </div>
                        </li>
                        <li>
                          <a href='#some' className='d-flex align-items-center link-danger'>
