              ...
              <Card className='card-border card-int mb-4'>
                <Card.Body>
                  <div className='d-flex justify-content-between align-items-start mb-3'>
                    ...
                    <Button variant='outline-secondary' className='btn-block flex-grow-0 flex-shrink-0 flex-basis-0'>
                      connect
                    </Button>
                  </div>
              ...
              <Card className='card-border card-int mb-4'>
                <Card.Body>
                  <div className='d-flex justify-content-between align-items-start mb-3'>
                    ...
                    <Button variant='primary' className='btn-block flex-grow-0 flex-shrink-0 flex-basis-0'>
                      connected
                    </Button>
                  </div>
