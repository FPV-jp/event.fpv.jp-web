  ...
  return (
    <Card className='card-border mb-0 h-100'>
      <Card.Header className='card-header-action'>
        <h6>
          New Customers
          <HkBadge bg='light' size='sm' text='dark' className='ms-1'>
            240
          </HkBadge>
        </h6>
      ...
      <Card.Body>
        ...
        <div className='contact-list-view'>
          <HkDataTable column={columns} rowData={data} rowSelection rowsPerPage={10} searchQuery={searchTerm} paginatorSize='sm' classes='display pb-30' responsive />
        </div>
      </Card.Body>
    </Card>
  )
