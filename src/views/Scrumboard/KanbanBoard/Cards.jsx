  ...
  return (
    <>
      <Draggable draggableId={props.card.id} index={props.index}>
        {(provided) => (
          <Card className={classNames('card-simple card-border tasklist')} ref={provided.innerRef} {...provided.draggableProps} id={props.card.id}>
            <Card.Header className='card-header-action' {...provided.dragHandleProps}>
              <div className='tasklist-handle'>
                <h6 className='text-uppercase fw-bold  d-flex align-items-center mb-0'>
                  ...
                  <HkBadge bg='violet' soft pill className='ms-2'>
                    {props.card.taskIds.length}
                  </HkBadge>
                </h6>
            ...
            <Row className='gx-3'>
              ...
              <Col md={12}>
                <Form.Group className='mt-3'>
                  ...
                  <Form.Check inline label='High' name='group1' type='radio' id='check1' />
                  <Form.Check inline label='Medium' name='group1' type='radio' id='check2' />
                  <Form.Check inline label='Low' name='group1' type='radio' id='check3' />
                </Form.Group>
              </Col>
            </Row>
          </Form>
