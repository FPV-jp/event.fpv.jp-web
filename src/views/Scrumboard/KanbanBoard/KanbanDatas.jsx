...
export const DATASET = {
  tasks: {
    ...
    'task-1': {
      ...
      Avatar: [
        { img: avatar13, name: 'Dean' },
        { img: avatar2, name: 'Danial' },
      ],
    ...
    'task-13': {
      ...
      Badges: [
        { title: 'Priority', bg: 'primary' },
        { title: 'Angular', bg: 'danger' },
      ],
      Footer: true,
      Task_Counter: '4/8',
      Task_Discuss: '',
    ...
    'task-19': {
      ...
      Description: '',
      Avatar: [
        { img: avatar9, name: 'Huma' },
        { img: avatar3, name: 'Katharine' },
        { img: avatar7, name: 'Danial' },
        { img: avatar13, name: 'Dean' },
      ],
    ...
    'task-21': {
      ...
      Task_Name: 'Authentication',
      Badges: [
        { title: 'Unassigned', bg: 'light' },
        { title: 'Collaborator', bg: 'danger' },
      ],
      Footer: true,
      Task_Counter: '12/18',
      Task_Discuss: '24',
