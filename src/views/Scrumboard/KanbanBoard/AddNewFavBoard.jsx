  ...
  return (
    <Modal show={show} onHide={onHide} centered dialogClassName='mw-400p'>
          ...
          <SimpleBar className='nicescroll-bar h-350p'>
            <ul className='p-3 pb-0'>
              <li className='d-flex align-items-center justify-content-between mb-3'>
                ...
                <Form.Check type='checkbox' id='customCheck2' defaultChecked />
              </li>
              <li className='d-flex align-items-center justify-content-between mb-3'>
                <div className='media d-flex align-items-center'>
                  <div className='media-head me-2'>
                ...
                <Form.Check type='checkbox' id='customCheck3' defaultChecked />
              </li>
              <li className='d-flex align-items-center justify-content-between mb-3'>
                <div className='media d-flex align-items-center'>
                  <div className='media-head me-2'>
              ...
              <li className='d-flex align-items-center justify-content-between mb-3'>
                ...
                <Form.Check type='checkbox' id='customCheck5' defaultChecked />
              </li>
              <li className='d-flex align-items-center justify-content-between mb-3'>
                <div className='media d-flex align-items-center'>
                  <div className='media-head me-2'>
                ...
                <Form.Check type='checkbox' id='customCheck6' defaultChecked />
              </li>
              <li className='d-flex align-items-center justify-content-between mb-3'>
                <div className='media d-flex align-items-center'>
                  <div className='media-head me-2'>
                ...
                <Form.Check type='checkbox' id='customCheck7' defaultChecked />
              </li>
              <li className='d-flex align-items-center justify-content-between mb-3'>
                <div className='media d-flex align-items-center'>
                  <div className='media-head me-2'>
              ...
              <li className='d-flex align-items-center justify-content-between mb-3'>
                ...
                <Form.Check type='checkbox' id='customCheck9' />
              </li>
              <li className='d-flex align-items-center justify-content-between mb-3'>
                <div className='media d-flex align-items-center'>
                  <div className='media-head me-2'>
                ...
                <Form.Check type='checkbox' id='customCheck10' />
              </li>
            </ul>
          </SimpleBar>
        </div>
      ...
      <Modal.Footer className='justify-content-center'>
        <Button variant='light' className='flex-1' onClick={onHide}>
          Cancel
        </Button>
        <Button variant='primary' className='flex-fill flex-1' onClick={onHide}>
          Add Board
        </Button>
      </Modal.Footer>
    </Modal>
