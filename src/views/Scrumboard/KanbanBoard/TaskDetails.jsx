              ...
              <Tab.Content className='mt-7'>
                <Tab.Pane eventKey='tabChecklist'>
                        ...
                        {!data.editable ? (
                          ...
                          <Form.Check.Label className='mb-3'>
                            <Form.Control
                              ...
                              value={newListLabel1}
                              onChange={(e) => setnewListLabel1(e.target.value)}
                              onKeyPress={(e) => {
                                if (e.key === 'Enter') updateCheckList('label1', index)
                              }}
                              autoFocus
                            />
                          </Form.Check.Label>
                  ...
                  <div className='d-flex align-items-center justify-content-between'>
                    ...
                    <div>
                      <a href='#some' className='btn btn-xs btn-icon btn-rounded btn-flush-light flush-soft-hover delete-checklist' data-bs-toggle='tooltip' data-bs-placement='top' data-bs-original-title='Edit'>
                        <span className='icon'>
                          <span className='feather-icon'>
                            <Icons.Edit2 />
                          </span>
                        ...
                        {!data.editable ? (
                          ...
                          <Form.Check.Label className='mb-3'>
                            <Form.Control
                              ...
                              placeholder='Add new Item'
                              value={newListLabel2}
                              onChange={(e) => setnewListLabel2(e.target.value)}
                              onKeyPress={(e) => {
                                if (e.key === 'Enter') updateCheckList('label2', index)
                              }}
                              autoFocus
                            />
                          </Form.Check.Label>
                  ...
                  <div className='card card-border note-block bg-orange-light-5'>
                    <div className='card-body'>
                      <div className='card-action-wrap'>
                        <button className='btn btn-xs btn-icon btn-flush-dark btn-rounded flush-soft-hover dropdown-toggle no-caret' aria-expanded='false' data-bs-toggle='dropdown'>
                          <span className='icon'>
                            <span className='feather-icon'>
                              <Icons.MoreVertical />
                            </span>
                  ...
                  <a href='#some' className='btn btn-outline-light btn-block'>
                    View more
                  </a>
                </Tab.Pane>
                ...
                <Tab.Pane eventKey='tabFiles'>
                  <Row>
                    <Col sm>
                      <HkDropZone>Drop files here to upload</HkDropZone>
                    </Col>
                  </Row>
                  ...
                  <div className='file-block'>
                    <div className='collapse-simple'>
                      <Card>
                        <Card.Header>
                          <Button as='a' data-bs-toggle='collapse' href='#files_collapse' aria-expanded='true'>
                            Yesterday
                          </Button>
                        </Card.Header>
                      ...
                      <Card>
                        <Card.Header>
                          <Button as='a' data-bs-toggle='collapse' href='#files_collapse_1' aria-expanded='true'>
                            23 April
                          </Button>
                        </Card.Header>
                                ...
                                <div className='media'>
                                  ...
                                  <div className='media-body'>
                                    ...
                                    <div>
                                      ...
                                      <a href='#some' className='btn btn-sm btn-icon btn-flush-dark btn-rounded flush-soft-hover dropdown-toggle no-caret' data-bs-toggle='dropdown'>
                                        <span className='icon'>
                                          <span className='feather-icon'>
                                            <Icons.MoreVertical />
                                          </span>
                                      ...
                                      <div className='dropdown-menu dropdown-menu-end'>
                                        <a className='dropdown-item ms-0' href='#some'>
                                          Download
                                        </a>
                                        <a className='dropdown-item ms-0' href='#some'>
                                          Delete
                ...
                <Tab.Pane eventKey='tabActivity'>
                  ...
                  <div className='collapse-simple'>
                    <Card>
                      <Card.Header>
                        <a role='button' data-bs-toggle='collapse' href='#activity_1' aria-expanded='true'>
                          Today
                        </a>
                      </Card.Header>
                    ...
                    <Card>
                      <Card.Header>
                        <a role='button' data-bs-toggle='collapse' href='#activity_2' aria-expanded='true'>
                          Yesterday
                        </a>
                      </Card.Header>
                          ...
                          <ListGroup as='ul' variant='flush' className='activity-list'>
                            <ListGroup.Item as='li'>
                              <div className='media'>
                                ...
                                <div className='media-body'>
                                  <p>
                                    <span className='text-dark'>Winston Churchills</span> created a note on UI components task list
                                  </p>
                            ...
                            <ListGroup.Item as='li'>
                              <div className='media'>
                                ...
                                <div className='media-body'>
                                  <p>
                                    <span className='text-dark'>Charlie Chaplin</span> moved components from all modules to in progress
                                  </p>
                                  <div className='last-activity-time'>Sep 10, 2021, 10:13 AM</div>
                                </div>
                              </div>
