          ...
          <Row className='gx-3'>
            ...
            <Col sm={12}>
              <Form.Group className='mb-3'>
                ...
                <small className='form-text text-muted'>Public setting will be seen by everybody with login details.</small>
              </Form.Group>
            </Col>
            <Col sm={12}>
              <Form.Group className='mb-3'>
              ...
              <Form.Group className='mb-3'>
                ...
                <InputGroup className='color-picker'>
                  <InputGroup.Text className='colorpicker-input-addon'>
                    <Form.Control type='color' value={avatarColor} onChange={(e) => setAvatarColor(e.target.value)} />
                  </InputGroup.Text>
            ...
            <Col sm={6}>
              <Form.Group className='mb-3'>
                <HkDropZone className='dropify-square w-60'>Upload Photo</HkDropZone>
              </Form.Group>
            </Col>
          </Row>
        </Form>
