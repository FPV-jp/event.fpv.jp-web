          ...
          >
            <Card.Body>
              <div className='card-action-wrap'>
                <Dropdown>
                  <Dropdown.Toggle variant={classNames({ light: props.task.growth === 'normal' || !props.task.growth }, { primary: props.task.growth === 'high' }, { warning: props.task.growth === 'average' }, { danger: props.task.growth === 'low' })} size='xs' className='btn-icon btn-rounded no-caret'>
                    <span className='icon'>
              ...
              <div className='media'>
                <div className='media-head'>
                  ...
                  {props.task.initLogo && (
                    <div className={classNames('avatar avatar-rounded', props.task.logoBg)}>
