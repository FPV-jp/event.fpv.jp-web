...
const DragDropCard = ({ cards, tasks, cardOrder, setCards, setTasks, setCardOrder }) => {
        ...
        {(provided) => (
          <div className='tasklist-wrap' {...provided.droppableProps} ref={provided.innerRef}>
            {cardOrder.map((id, index) => {
              ...
              return <Board key={card.id} card={card} tasks={cardTasks} index={index} renameBoard={boardRename} onRemoveBoard={onRemoveBoard} clearBoard={clearBoard} onRemoveTask={onRemoveTask} onAddNewTask={onAddNewTask} />
            })}
