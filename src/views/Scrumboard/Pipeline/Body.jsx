...
const PipelineBody = () => {
  ...
  const [dataset, setDataset] = useState(() => {
    const savedDataset = sessionStorage.getItem('pipeline-board')
  ...
  useEffect(() => {
    sessionStorage.setItem('pipeline-board', JSON.stringify({ tasks, cards, cardOrder }))
      ...
      <div className='taskboard-body taskboard-body-alt'>
        <div>
          <PerfectScrollbar className='tasklist-scroll position-relative'>
            ...
            <div id='tasklist_wrap' className='tasklist-wrap'>
              <DragDropCard cards={cards} tasks={tasks} cardOrder={cardOrder} setCards={setCards} setTasks={setTasks} setCardOrder={setCardOrder} />
      ...
      <Modal Modal show={addNewBoard} onHide={() => setAddNewBoard(!addNewBoard)} size='sm' centered>
        ...
        <div className='modal-content'>
          ...
          <div className='modal-footer align-items-center'>
            ...
            <Button variant='primary' className='btn-add-tasklist' onClick={onAddNewCard}>
              Add
            </Button>
          </div>
        </div>
