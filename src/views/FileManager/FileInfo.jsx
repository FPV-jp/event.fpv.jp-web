          ...
          <Tab.Content className='mt-5'>
            <Tab.Pane eventKey='tabInfo'>
              <div className='collapse-simple'>
                <Card>
                  <Card.Header>
                    <Link to='#fl_info' role='button' data-bs-toggle='collapse' aria-expanded='true'>
                      Specification
                    </Link>
                  </Card.Header>
                ...
                <Card>
                  ...
                  <div id='settings' className='collapse show'>
                    <Card.Body>
                      ...
                      <Link to='#' className='d-block text-dark fs-7 mb-2'>
            ...
            <Tab.Pane eventKey='tabActivity'>
              <div className='collapse-simple'>
                <Card>
                  <Card.Header>
                    <Link to='#act_info1' role='button' data-bs-toggle='collapse' aria-expanded='true'>
                      Yesterday
                    </Link>
                  </Card.Header>
                ...
                <Card>
                  <Card.Header>
                    <Link role='button' data-bs-toggle='collapse' to='#act_info2' aria-expanded='true'>
                      23 April
                    </Link>
                  </Card.Header>
