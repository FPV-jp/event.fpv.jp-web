  ...
  return cell.map((data, indx) => (
    <div className='media fmapp-info-trigger' key={indx}>
      <div className='media-head me-3'>
        {data.icons && (
          <div className={classNames('avatar avatar-icon avatar-sm', `avatar-soft-${data.iconBg}`)}>
    ...
    <div className='avatar-group avatar-group-overlapped'>
      {cell.map((data, indx) => (
        <React.Fragment key={indx}>
          {data.img && (
            <HkTooltip placement='top' title={data.userName}>
...
export const data = [
  {
    ...
    sharing: [
      { img: avatar13, userName: 'Dean' },
      { img: avatar14, userName: 'Danial' },
    ],
  ...
  },
  {
    ...
    sharing: [
      { img: avatar12, userName: 'Dean' },
      { img: avatar13, userName: 'Danial' },
    ],
  ...
  },
  {
    ...
    sharing: [
      { img: avatar12, userName: 'Katharine' },
      { img: avatar13, userName: 'Danial' },
      { img: avatar14, userName: 'Dean' },
      { intAvt: 'B', initAvtBg: 'success', userName: 'Tom' },
    ],
