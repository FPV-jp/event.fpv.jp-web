  ...
  return (
    <div className='mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6'>
      <div className='sm:col-span-3'>
        ...
        <div className={classNames(`bg-${color}-500`, 'h-10 px-8 text-xs font-medium rounded-md flex items-center justify-center text-white cursor-pointer')}>{color}</div>
      </div>
      <div className='sm:col-span-3'>
