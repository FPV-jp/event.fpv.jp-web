  ...
  return (
    <div className='relative w-full text-gray-700'>
      <input //
        ...
        role='presentation'
      />
      <button type='button' className='absolute right-0 h-full px-3 text-gray-400 focus:outline-none disabled:cursor-not-allowed disabled:opacity-40'>
        ...
        <div ref={refs.setFloating} style={{ ...floatingStyles, zIndex: 9999 }}>
          <div style={styles}>
            <TimeKeeper //
              ...
              // doneButton={(newTime) => (
              //   <div className='text-center py-2 px-0' onClick={() => setopenTimePicker(false)}>
              //     キャンセル
              //   </div>
              // )}
            />
