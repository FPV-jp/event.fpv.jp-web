...
import JampackBadge from 'components/@jampack-badge/@jampack-badge'
      ...
      <Container fluid>
        ...
        <div className='nav-start-wrap'>
          ...
          <Dropdown as={Form} className='navbar-search' show={showDropdown}>
            ...
            <Dropdown.Menu as={motion.div} initial='initial' animate={showDropdown ? 'open' : 'close'} variants={pageVariants} transition={{ duration: 0.3 }} className={classNames('p-0')}>
              {/* Mobile Search */}
              ...
              <SimpleBar className='dropdown-body p-2'>
                ...
                <Dropdown.Item className='bg-transparent'>
                  <JampackBadge bg='secondary' soft pill className='me-1'>
                    React
                  </JampackBadge>
                  <JampackBadge bg='secondary' soft pill className='me-1'>
                    Node JS
                  </JampackBadge>
                  <JampackBadge bg='secondary' soft pill>
                    SCSS
                  </JampackBadge>
                </Dropdown.Item>
        ...
        <div className='nav-end-wrap'>
          <Nav className='navbar-nav flex-row'>
            <Nav.Item>
              <Button variant='flush-dark' as={Link} to='/email' className='btn-icon btn-rounded flush-soft-hover'>
                <span className='icon'>
                  <span className=' position-relative'>
                    <span className='feather-icon'>
                      <Inbox />
                    </span>
                    <JampackBadge bg='primary' soft pill size='sm' className='position-top-end-overflow-1'>
                      4
                    </JampackBadge>
                  </span>
                </span>
                ...
                <Dropdown.Menu align='end'>
                  <div className='p-2'>
                    <div className='media'>
                      ...
                      <div className='media-body'>
                        <Dropdown>
                          <Dropdown.Toggle as={Link} to='#' className='d-block fw-medium text-dark'>
                            Hencework
                          </Dropdown.Toggle>
                          <Dropdown.Menu align='end'>
                            <div className='p-2'>
                              <div className='media align-items-center active-user mb-3'>
                                ...
                                <div className='media-body'>
                                  <Link to='#' className='d-flex link-dark'>
                                    Hencework <i className='ri-checkbox-circle-fill fs-7 text-primary ms-1' />
                                  </Link>
